"""
Redis-based session manager - Most reliable cross-page refresh state persistence solution
"""
...
class RedisSessionManager:
    ...
    def _init_redis(self) -> bool:
        ...
        try:
            ...
            # Only show connection failure warning when Redis is enabled
            redis_enabled = os.getenv('REDIS_ENABLED', 'false').lower()
            if redis_enabled == 'true':
    ...
    def _get_session_key(self) -> str:
        ...
        try:
            ...
            # If unable to get session_id, use hash of IP+UserAgent
            # Note: This is a fallback solution, may not be precise enough
            ...
            # Generate unique identifier based on user information
    ...
    def save_analysis_state(self, analysis_id: str, status: str = "running",
        ...
        """Save analysis state and form configuration"""
        try:
            session_data = {
    ...
    def _load_from_file(self, session_key: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            st.warning(f"⚠️ File load failed: {e}")
            return None
    ...
    def _delete_file(self, session_key: str):
        ...
        try:
            ...
            st.warning(f"⚠️ File deletion failed: {e}")
...
def get_persistent_analysis_id() -> Optional[str]:
    ...
    try:
        ...
        # 3. Finally restore latest analysis from Redis/file
