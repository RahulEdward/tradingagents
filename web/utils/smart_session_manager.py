...
class SmartSessionManager:
    ...
    def get_debug_info(self) -> Dict[str, Any]:
        ...
        # Get debug information from currently used manager
        if self.use_redis and self.redis_manager:
            try:
...
def get_persistent_analysis_id() -> Optional[str]:
    ...
    try:
        ...
        # 3. Finally restore latest analysis from analysis data
        try:
...
def get_session_debug_info() -> Dict[str, Any]:
    """Get session manager debug information"""
