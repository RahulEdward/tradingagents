...
Provides common UI components and styles
"""
...
def apply_hide_deploy_button_css():
    """
    Apply CSS styles to hide Deploy button and toolbar
...
def apply_common_styles():
    ...
    Includes hiding Deploy button and other beautification styles
    """
    # Hide Deploy button
