"""
File-based session manager - Reliable solution that doesn't depend on Redis
Suitable for cases without Redis or when Redis connection fails
"""
...
class FileSessionManager:
    ...
    def _get_browser_fingerprint(self) -> str:
        ...
        try:
            # Method 1: Use fixed session identifier
            # Check if session identifier is already saved in session_state
            if hasattr(st.session_state, 'file_session_fingerprint'):
                return st.session_state.file_session_fingerprint

            # Method 2: Find recent session files (within 24 hours)
    ...
    def _cleanup_old_sessions(self):
        ...
        try:
            ...
            pass  # Cleanup failure doesn't affect main functionality
